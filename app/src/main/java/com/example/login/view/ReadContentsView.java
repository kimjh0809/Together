...
public class ReadContentsView extends LinearLayout {
    ...
    public ReadContentsView(Context context, @NonNull AttributeSet attributeSet) {
    ...
    public void setPostInfo(PostInfo postInfo){
       ...
       publisherTextView.setText(postInfo.getPublisher());
       publisherTextView.setTextSize(2,22);
        createdAtTextView.setText(new SimpleDateFormat("yyyy-MM-dd HH-mm", Locale.getDefault()).format(postInfo.getCreatedAt()));
