...
import com.example.login.GpsTracker;
...
public class LocationActivity extends BasicActivity implements MapView.CurrentLocationEventListener, MapView.MapViewEventListener
{
    private GpsTracker gpsTracker;
    private static final String LOG_TAG = "LocationButton";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Button SendLocationButton =(Button) findViewById(R.id.send);
        SendLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String str= nickname+"의 위치를 보내요 -> http://maps.google.com/?q="+latitude+","+longitude;

                myStartActivity(ChatActivity.class,str);
...
//사용자가 GPS 활성 시켰는지 검사
    ...
    private void  myStartActivity(Class c,String map){
